...
No pairing or Wi-Fi is required. VS Code provides the equivalent **BLE Flash**
task. Only the application `.bin` is supported; bootloader, partition-table,
merged, and full-flash images still require USB.
